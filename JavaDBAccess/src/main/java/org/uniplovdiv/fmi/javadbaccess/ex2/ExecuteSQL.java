...
public class ExecuteSQL
{
  ...
  {
    try (Connection conn = Connecting.connectJdbc4Oracle();
            PreparedStatement pstmt = conn.prepareStatement("select last_name, hire_date from employees");
  ...
  {
    try (Connection conn = Connecting.connectJdbc4Oracle();
            PreparedStatement pstmt = conn.prepareStatement("insert into countries(country_id, country_name, region_id) values(?, ?, ?)"))
    {
